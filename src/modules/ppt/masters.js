...
export function createMasterSlides(pptx) {
  ...
  let objImg = {
    path: '../../assets/images/securonix_logo_color.png',
    x: 4.6,
    y: 3.5,
    w: 4,
    h: 1.8,
    ...
    objects: [
      {
        text: {
          text: '(margin-top)',
          options: { ...TEXT_PROPS, ...{ x: 0, y: 0, w: '100%', h: MARGINS[0] } },
        },
      },
      {
        text: {
          ...
          options: {
            ...TEXT_PROPS,
            ...{ x: 0, y: 7.5 - MARGINS[2], w: '100%', h: MARGINS[2], flipV: true },
          },
        },
      },
    ],
