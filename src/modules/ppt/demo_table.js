...
function genSlide01(pptx) {
  ...
  slide.addTable(
    [[{ text: 'Table Examples 1', options: BASE_TEXT_OPTS_L }, BASE_TEXT_OPTS_R]],
    BASE_TABLE_OPTS,
  )
...
function genSlide02(pptx) {
  ...
  let arrTabRows4 = [
    [
      ...
      {
        text: 'B1\nB2',
        options: { rowspan: 2, fill: { color: pptx.colors.ACCENT2, transparency: 25 } },
      },
      {
        text: 'C1\nC2\nC3',
        options: { rowspan: 3, fill: { color: pptx.colors.ACCENT6, transparency: 25 } },
      },
    ],
    ...
    [
      {
        text: 'A3 -> B3',
        options: { colspan: 2, fill: { color: pptx.colors.ACCENT5, transparency: 25 } },
      },
    ],
  ]
...
function genSlide03(pptx) {
  ...
  slide.addTable(
    [[{ text: 'Table Examples 3', options: BASE_TEXT_OPTS_L }, BASE_TEXT_OPTS_R]],
    BASE_TABLE_OPTS,
  )
  slide.addNotes('API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-tables.html')
...
function genSlide04(pptx) {
  ...
  slide.addTable(
    [[{ text: 'Table Examples 4', options: BASE_TEXT_OPTS_L }, BASE_TEXT_OPTS_R]],
    BASE_TABLE_OPTS,
  )
  slide.addNotes('API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-tables.html')
  ...
  let arrTextObjects = [
    ...
    [
      ...
      {
        text: 'Hyperlink',
        options: { hyperlink: { url: 'https://github.com/gitbrent/pptxgenjs' } },
      },
    ],
  ]
...
function genSlide05(pptx) {
  ...
  slide.addTable(
    [[{ text: 'Table Examples 5', options: BASE_TEXT_OPTS_L }, BASE_TEXT_OPTS_R]],
    BASE_TABLE_OPTS,
  )
  slide.addNotes('API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-tables.html')
  ...
  let arrTextObjects = [
    {
      text: '1st line',
      options: { fontSize: 24, color: '99ABCC', align: 'right', breakLine: true },
    },
    {
      text: '2nd line',
      options: { fontSize: 36, color: 'FFFF00', align: 'center', breakLine: true },
    },
    { text: '3rd line', options: { fontSize: 48, color: '0088CC', align: 'left' } },
  ]
...
function genSlide06(pptx) {
  ...
  slide.addTable(
    [[{ text: 'Table Examples 6', options: BASE_TEXT_OPTS_L }, BASE_TEXT_OPTS_R]],
    BASE_TABLE_OPTS,
  )
  slide.addNotes('API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-tables.html')
      ...
      [
          ...
          text: [
            {
              ...
              options: { color: 'CC0000', bullet: { code: '2605' } },
            },
            {
              text: 'and i am the next text object',
              options: { color: '00CD00', bullet: { code: '25BA' } },
            },
            {
        ...
        },
        {
          text: [
            {
              text: 'Cell',
              options: { fontSize: 36, fontFace: 'Courier', color: 'dd0000', breakLine: true },
            },
...
function genSlide07(pptx) {
  ...
  ]
  {
    ...
    TABLE_NAMES_F.forEach((name, idx) => {
      let strText =
        idx == 0 ? LOREM_IPSUM.substring(0, 100) : LOREM_IPSUM.substring(idx * 100, idx * 200)
...
function genSlide08(pptx) {
  ...
  TABLE_NAMES_F.forEach((name, idx) => {
    ...
    arrRows.push([
      ...
      {
        text: [
          { text: 'Title', options: { bold: true, color: 'FF0000', breakLine: true } },
          { text: `>${strText}<` },
        ],
      },
    ])
...
function genSlide09(pptx) {
  ...
  slide.addNotes('API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-tables.html')
  slide.addText(
    [{ text: 'Table Examples: Auto-Paging Calculations', options: DEMO_TITLE_TEXTBK }],
    {
      x: 0.23,
      y: 0.13,
      w: 8,
  ...
  for (let rowIdx = 0; rowIdx < 9; rowIdx++) {
    let col3Lines = [
      { text: 'Complex-Title', options: { bold: true, color: 'FF0000', breakLine: true } },
    ]
