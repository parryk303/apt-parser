...
import { HYPERLINK_SVG, LOGO_STARLABS, SVG_BASE64, UNITE_PNG } from './media.js'
...
function genSlide01(pptx) {
  ...
  slide.addTable(
    [[{ text: 'Image Examples: Misc Image Types', options: BASE_TEXT_OPTS_L }, BASE_TEXT_OPTS_R]],
    BASE_TABLE_OPTS,
  )
...
function genSlide02(pptx) {
  ...
  slide.addTable(
    [
      [
        { text: 'Image Examples: Image Sizing/Rounding', options: BASE_TEXT_OPTS_L },
        BASE_TEXT_OPTS_R,
      ],
    ],
    BASE_TABLE_OPTS,
...
function genSlide03(pptx) {
  ...
  slide.addTable(
    [[{ text: 'Image Examples: Image Rotation', options: BASE_TEXT_OPTS_L }, BASE_TEXT_OPTS_R]],
    BASE_TABLE_OPTS,
  )
  slide.addNotes('API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-images.html')
  slide.slideNumber = { x: '50%', y: '95%', w: 1, h: 1, color: COLOR_BLUE }
  ...
  // EXAMPLES
  slide.addText('Rotate: `rotate:45`, `rotate:180`, `rotate:315`', {
    x: 0.5,
    y: 0.6,
    w: 6.0,
    h: 0.3,
...
function genSlide04(pptx) {
  ...
  slide.addTable(
    [[{ text: 'Image Examples: Image URLs', options: BASE_TEXT_OPTS_L }, BASE_TEXT_OPTS_R]],
    BASE_TABLE_OPTS,
  )
  slide.addNotes('API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-images.html')
  slide.slideNumber = { x: '50%', y: '95%', color: COLOR_BLUE }
  ...
  // TOP-LEFT: jpg
  slide.addText([{ text: `path:"${IMAGE_PATHS.ccLogo.path}"` }], {
    ...BASE_CODE_OPTS,
    ...{ x: 0.5, y: 0.6, w: 3.3, h: 0.7, fontSize: 11 },
  })
  slide.addImage({ path: IMAGE_PATHS.ccLogo.path, x: 0.5, y: 1.44, h: 2.5, w: 3.33 })

  // TOP-CENTER: png
  slide.addText([{ text: `path:"${IMAGE_PATHS.wikimedia2.path}"` }], {
    ...BASE_CODE_OPTS,
    ...{ x: 4.55, y: 0.6, w: 3.27, h: 0.7, fontSize: 11 },
  })
